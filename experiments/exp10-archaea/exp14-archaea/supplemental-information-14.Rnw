...
\title{Supplemental Information 14: Analysis of the Archaea superkingdom }
\date{April 2020}
...
source(file.path(root, "experiments/exp5-decentralization/decentralization_functions.R"))
source(file.path(root, "experiments/exp14-archaea/local-14.R"))
...
<<>>=
t <- tax_archaea; make_figure( t, ifelse(is.na(tree[t2i(t), "name"]), t, tree[t2i(t), "name"]), figurefile,
...
<<>>=
decentralization_animation( relative_to = tax_archaea, rrank = "species", mytitle = "Archaea", figurefile,
                              lf_quant = 0.20, rf_quant = 0.87, lc_quant = 0.5, rc_quant = 0.99,
                               top_left = -7, top_even = 3, top_right = 7, stretch = 1.0) 
decentralization_animation( relative_to = tax_archaea, rrank = "genus", mytitle = "Archaea", figurefile,
                              lf_quant = 0.20, rf_quant = 0.87, lc_quant = 0.5, rc_quant = 0.99,
                               top_left = -2, top_even = 3, top_right = 3, stretch=1.0) 
@ 
